...
//		System.out.println("createBoundingBox ");
	...
	public boolean contains(Location l){
		return ( l.getWorld().getName().equals(lower.getWorld().getName()) && 
				(l.getBlockX() >= lower.getBlockX() && l.getBlockX() <= upper.getBlockX()) &&
				(l.getBlockY() >= lower.getBlockY() && l.getBlockY() <= upper.getBlockY()) &&
				(l.getBlockZ() >= lower.getBlockZ() && l.getBlockZ() <= upper.getBlockZ()));
	}

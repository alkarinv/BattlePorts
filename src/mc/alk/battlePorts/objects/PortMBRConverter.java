...
public class PortMBRConverter implements MBRConverter<Port> {
	...
	public double getMax(int dim, Port port) {
		switch(dim){
		case 0: return port.getSrcUpperCorner().getBlockX();
		case 1: return port.getSrcUpperCorner().getBlockZ();
		}
		return 0;
	}
	...
	public double getMin(int dim, Port port) {
		switch(dim){
		case 0: return port.getSrcLowerCorner().getBlockX();
		case 1: return port.getSrcLowerCorner().getBlockZ();
		}
		return 0;
	}
}

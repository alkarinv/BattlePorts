...
public class BattlePorts extends JavaPlugin
{
	...
	private static BattlePorts plugin;
	...
	private final Set<String> pluginsEnabled = new HashSet<String>();
	...
	public Collection<String> getPluginsEnabled()
	{
		return pluginsEnabled;
	}

	public static BattlePorts getSelf() {
		return plugin;
	}
}

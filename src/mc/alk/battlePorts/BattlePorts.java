...
public class BattlePorts extends JavaPlugin
{
	...
	private final PortExecutor portExecutor = new PortExecutor(portController);
	private PortalExecutor portalExecutor = null;
	private static final BPPlayerListener playerListener = new BPPlayerListener(
			portController);
	private static final PortSerializer portSerializer = new PortSerializer(
			portController);

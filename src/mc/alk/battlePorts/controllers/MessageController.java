...
public class MessageController
{
	...
	public static String getMessage(String prefix, String node,
			Object... varArgs)
	{
		try
		{
			...
			StringBuilder buf = new StringBuilder(n.getString("prefix",
					"[Arena]"));
	...
	public static String getMessageNP(String prefix, String node,
			Object... varArgs)
	{
		ConfigurationSection n = mc.getConfigurationSection(prefix);
	...
	public static String getMessageAddPrefix(String pprefix, String prefix,
			String node, Object... varArgs)
	{
		ConfigurationSection n = mc.getConfigurationSection(prefix);
